...
import RegisterViewDetails from "./RegisterViewDetails"; // ✅ fixed import
      ...
      <div className="flex flex-col justify-center items-center w-full">
        ...
        <div className="grid grid-cols-1 gap-6 mt-6 w-full px-2 sm:px-4">
          {registerDetails.map((detail) => (
            <div
              key={detail.id}
              className="border rounded-2xl p-6 shadow-md bg-white w-full sm:max-w-3xl mx-auto"
            >
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  <p className="text-base sm:text-lg font-medium">
                    Film Title: <span className="font-normal">{detail.title}</span>
                  </p>
                  <p className="text-base sm:text-lg font-medium">
                    Producer: <span className="font-normal">{detail.producer}</span>
                  </p>
                </div>
