import { X, Calendar, MapPin, User, Film, Building, Award, Music, Users, Tag, CheckCircle, XCircle, Clock, AlertCircle } from 'lucide-react';
          ...
          {(detail.status === "PENDING" || detail.status === "IN_PROGRESS") && (
            <div className="flex flex-col sm:flex-row gap-3 mt-8 pt-6 border-t border-gray-200">
              ...
              <button 
                ...
                className="flex-1 bg-red-600 text-white py-3 px-6 rounded-xl font-medium hover:bg-red-700 transition-colors flex items-center justify-center gap-2"
              >
